 ...
 * @author daiki
 */
public class formperahukertas extends javax.swing.JFrame {

    /**
     * Creates new form Form4
     */
    public formperahukertas () {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PERAHU KERTAS.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formperahukertas ().setVisible(true);
            }
        });
    }
